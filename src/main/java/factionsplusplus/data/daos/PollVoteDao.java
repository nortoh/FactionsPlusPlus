...
import factionsplusplus.models.PollVote;
...
public interface PollVoteDao {
    @SqlUpdate("""
        INSERT IGNORE INTO
            poll_votes (id, player_id, poll_id, option_id)
        VALUES (:getUUID, :getPlayerUUID, :getPollUUID, :getPollOptionUUID)
    """)
    void insert(@BindMethods PollVote vote);

    @SqlUpdate("INSERT IGNORE INTO poll_votes (id, poll_id, option_id) VALUES (?, ?, ?)")
    void insert(UUID uuid, UUID pollUUID, UUID optionUUID);
